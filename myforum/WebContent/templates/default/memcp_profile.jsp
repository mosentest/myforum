...
<table summary="<bean:message key="memcp_profile"/>" cellspacing="0" cellpadding="0">
	...
	<c:choose><c:when test="${typeid==1}">
		<tr><th><label for="oldpassword"><bean:message key="old_password"/></label></th><td><input type="password" name="oldpassword" id="oldpassword" size="25" tabindex="1" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('oldpassword',this);" title="<bean:message key="keyboard_title"/>"></c:if></td></tr>
		<tr><th><label for="newpassword"><bean:message key="new_password"/></label></th><td><input type="password" name="newpassword" id="newpassword" size="25" tabindex="2" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('newpassword',this);" title="<bean:message key="keyboard_title"/>"></c:if></td></tr>
		<tr><th><label for="newpassword2"><bean:message key="new_password_confirm"/></label></th><td><input type="password" name="newpassword2" id="newpassword2"size="25" tabindex="3" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('newpassword2',this);" title="<bean:message key="keyboard_title"/>"></c:if></td></tr>
