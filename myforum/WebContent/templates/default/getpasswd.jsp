	...
	<div class="mainbox">
		...
		<table cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<td><input type="password" name="newpasswd1" id="newpasswd1" size="25" /><c:if test="${settings.hide_keyboard!=1}"><input type="button"  class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('newpasswd1',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp;</td>
			</tr>
			<tr>
				<th><bean:message key="new_password_confirm"/>:</th>
				<td><input type="password" name="newpasswd2" id="newpasswd2" size="25" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('newpasswd2',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp;</td>
			</tr>
			<tr class="btns">
				<th></th>
