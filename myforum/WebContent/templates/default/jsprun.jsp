...
<div id="foruminfo"><div id="userinfo">
	...
	<c:when	test="${empty settings.passport_status}">
		<form id="loginform" method="post" name="login" action="logging.jsp?action=login&loginsubmit=true">
			...
			<c:if test="${settings.hide_keyboard!=1}"><input type="button" style="margin-left: -27px;" class="keybord_button" onclick="jrunKeyBoard('password',this);" title="<bean:message key="keyboard_title"/>"></c:if>
