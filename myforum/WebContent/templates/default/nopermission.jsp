			...
			<div class="box" style="width: 60%; margin: 10px auto;">
				<table cellspacing="0" cellpadding="4" width="100%">
					...
					<tbody>
						...
						<tr><td><bean:message key="passwordf" /></td><td><input type="password" name="password" id="password" size="25" tabindex="3" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('password',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp; &nbsp;<em class="tips"><a href="member.jsp?action=lostpasswd"><bean:message key="lostpassword" /></a></em></td></tr>
