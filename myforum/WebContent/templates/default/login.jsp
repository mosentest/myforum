...
<div class="mainbox formbox">
	...
	<table summary="<bean:message key="member_login" />" cellspacing="0" cellpadding="0">
		...
		<tr><th><label for="password"><bean:message key="passwordf" /></label></th><td><input type="password" id="password" name="password" size="25" tabindex="5" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" style="margin-left: -23px;" class="keybord_button" onclick="jrunKeyBoard('password',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp;<a href="member.jsp?action=lostpasswd"> <bean:message key="lostpassword" /></a></td></tr>
