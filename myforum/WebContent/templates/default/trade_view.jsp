		...
		<table summary="<bean:message key="trade_order" />" cellspacing="0" cellpadding="0">
			...
			<c:if test="${tradelog.offline>0&&!empty offlinenexts}">
				<tr>
					...
					<td><input id="password" name="password" type="password" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('password',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp;</td>
				</tr>
				<tr>
