...
<div class="mainbox formbox">
	...
	<table summary="<bean:message key="register" />" cellspacing="0" cellpadding="0">
		...
		<tr><th><label for="password"><bean:message key="passwordf" /> *</label></th><td><input type="password" name="password" size="25" id="password" onBlur="checkpassword()" tabindex="4" /><c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -24px;" onclick="jrunKeyBoard('password',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp; <span id="checkpassword">&nbsp;</span></td></tr>
		<tr><th><label for="password2"><bean:message key="password_confirm" /> *</label></th><td><input type="password" name="password2" size="25" id="password2" onBlur="checkpassword2()" tabindex="5" /> <c:if test="${settings.hide_keyboard!=1}"><input type="button" class="keybord_button" style="margin-left: -26px;" onclick="jrunKeyBoard('password2',this);" title="<bean:message key="keyboard_title"/>"></c:if>&nbsp;<span id="checkpassword2">&nbsp;</span></td></tr>
