...
<form method="post" name="settings" id="settings" action="admincp.jsp?action=settings&do=styles">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
		...
		<tbody id="menu_769d4620d4fb5b13" style="display: yes">
			...
			<tr>
				<td width="45%" class="altbg1">
					<b><bean:message key="a_setting_closekeyboard"/></b>
					<br />
					<span class="smalltxt"><bean:message key="a_setting_closekeyboard_comment"/></span>
				</td>
				<td class="altbg2">
					<input class="radio" type="radio" name="hide_keyboard" value="1" checked> <bean:message key="yes" /> &nbsp; &nbsp;								
					<input class="radio" type="radio" name="hide_keyboard" value="0" ${settings.hide_keyboard!=1?"checked":""}> <bean:message key="no" />
				</td>
			</tr>
		</tbody>
	</table>
